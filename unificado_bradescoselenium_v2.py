...
def etl_txt(arquivos,caminho_parcial):
    ...
    df3 = df2[df2['Status / Aba'].str.contains('BRA', na=False)]
    if df1.empty:
        df1 = df3
    else:
...
if __name__ == '__main__':
    ...
    caminho_final = "C:\\Users\\"+usuario+"\\Projetos Python\\Análises\\Análises Gerais\\BR.BradescoAnterior.xlsx"
    #caminho_final = "C:\\Users\\"+usuario+"\\Projetos Python\\Análises\\Análises Gerais\\BR.BradescoAtual.xlsx"
