...
def etl_txt(arquivos,caminho_parcial):
    ...
    df3 = df2[df2['CLASSIFICACAO'].str.contains('Tarifa CNAB.', na = False)]
    df3 = df3[df3['Status / Aba'].str.contains('BB')]
    if df1.empty:
        df1 = df3
    else:
        df1 = pd.concat([df1,df3])
    
    df3 = df2[df2['CLASSIFICACAO'].str.contains('Tarifa DOC/TED.', na = False)]
    df3 = df3[df3['Status / Aba'].str.contains('BB')]
    if df1.empty:
        df1 = df3
    else:
...
if __name__ == '__main__':
    ...
    caminho_final = "C:\\Users\\"+usuario+"\\Projetos Python\\Análises\\Análises Gerais\\Tarifa DOC-TED.xlsx"
