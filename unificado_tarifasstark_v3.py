...
def etl_txt(arquivos,caminho_parcial):
    ...
    df3 = df2[df2['Status / Aba'].str.contains('STA')]
    df3= df3.fillna(value = '')
    df3 = df3[df3['DESCRIÇÃO'].str.contains('PRINCIPAL - Estorno')]
    df3 = df3[df3['CLASSIFICACAO'] != 'DOC/TED Dev [cat. Se anulam (C/D)]']
    if df1.empty:
        df1 = df3
    else:
...
if __name__ == '__main__':
    ...
    caminho_final = "C:\\Users\\"+usuario+"\\Projetos Python\\Análises\\Análises Gerais\\TarifasStark.xlsx"
    caminho_parcial = "C:\\Users\\"+usuario+"\\Projetos Python\\temp\\"
    arquivos = "C:\\Users\\"+usuario+"\\Python\\Custos Consolidados\\"
    ...
    ################################################
    arquivos = glob.glob(arquivos+"*07*")
    ################################################
