...
def etl_txt(arquivos,caminho_parcial):
    ...
    df3 = df2[df2['DESCRIÇÃO'].str.contains('PIX', na = False)]
    df3 = df3[df3['Status / Aba'] != 'BB_1']
    df3 = df3[df3['Status / Aba'] != 'BB_2']
    df3 = df3[df3['Status / Aba'] != 'BB_3']
    df3 = df3[df3['Status / Aba'] != 'BB_4']
    df3 = df3[df3['Status / Aba'] != 'BB_5']
    df3 = df3[df3['Status / Aba'] != 'QSH_1']
    df3 = df3[df3['Status / Aba'] != 'QSH_2']
    if df1.empty:
        df1 = df3
    else:
...
if __name__ == '__main__':
    ...
    caminho_final = "C:\\Users\\"+usuario+"\\Projetos Python\\Análises\\Recebimento PIX\\DEMAISPIX.xlsx"
